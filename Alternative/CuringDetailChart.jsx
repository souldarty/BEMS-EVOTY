...
const CURING_KEYS = ["(104-C2-LV01 Double Power Curing Line A, B & C)","(Curing Line D Busduct Line D Curing)","(Curing Line E Busduct Line E Curing)","(Curing Line F Busduct Line F Curing)","(104-C1-LV04 Spray painting & condensate)","(DB.C.EXT.1)","(104.C1.LV01.2)","(104.C1.LV01.1)","(902C LV01 1)","(DB MCC Curing AHU Curing)","(104-C1-LV01 PMCC/CB/2A AHU)"];
...
const CuringDetailChart = () => {
  ...
  return (
    <motion.div className="chart-container p-4 bg-white rounded-lg shadow-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <h2 className="text-lg font-bold mb-2">Monthly Consumption Details: Curing Area</h2>
...
export default CuringDetailChart;
