...
const WAREHOUSE_KEYS = ["(106 C1 LV01 1)","(106 C1 LV01 2)","(902D.C1.LV01.1)","(Warehouse Pirelli (New SDP))"];
...
const WarehouseDetailChart = () => {
  ...
  return (
    <motion.div className="chart-container p-4 bg-white rounded-lg shadow-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <h2 className="text-lg font-bold mb-2">Monthly Consumption Details: Warehouse Area</h2>
