...
const RD_LAB_KEYS = ["(108-A1-LV01 (DB Lab/2))","(101-A2-LV01-2 (DB Lab.lighting))","(DB- AHU Indoor Test AC & Heater Indoortest)","(107-C1-LV01 DB Indoor Test)","(107 C1 LV01 1)"];
...
const RAndDLabDetailChart = () => {
  ...
  return (
    <motion.div className="chart-container p-4 bg-white rounded-lg shadow-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <h2 className="text-lg font-bold mb-2">Monthly Consumption Details: R&D Lab Area</h2>
...
export default RAndDLabDetailChart;
