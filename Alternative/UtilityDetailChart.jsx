...
const UTILITY_KEYS = ["(MCC Vaccum pump Vaccum & condensat pump)","(204.C1.LV01.1)","(Air Compressor No.3)","(Air Compressor No.1)","(Air Compressor No.2)","(202-U1-LV01 Cooling Tower MCC)","(Water Cooled Chiller No. 1)","(Water Cooled Chiller No. 2)","(Water Cooled Chiller No. 3)","(202-U2-LV01 Industrial Water Chiller MCC)","(WWTP WWTP area)","((204-DG2-1 Boiler House) - (ATS MV C UPS 120 KVA))","((ATS 2 MV U) - (GUEST HOUSE))","(ATS Panel Emergency MV A)","(ATS Panel Emergency MV B)","(ATS Panel Emergency MV C)","(ATS Panel MV U)"];
...
const UtilityDetailChart = () => {
  ...
  return (
    <motion.div className="chart-container p-4 bg-white rounded-lg shadow-xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <h2 className="text-lg font-bold mb-2">Monthly Consumption Details: Utility Area</h2>
...
export default UtilityDetailChart;
