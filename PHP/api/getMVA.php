...
/**
 * getMVA.php
 * Backend untuk Dashboard MV-A (mvAMonitoring.jsx)
 *
 * REVISION: April 2026 (Rev 10) - DYNAMIC Device List from dbo.modbus_devices
 */
...
try {
    ...
    // Jika belum ada device sama sekali yang diatur untuk MV-A di database
    ...
    // ============================================================
    // STEP 2 — Fetch Data dengan Filter Strict Subgroup IN (...)
    // ============================================================
    ...
    foreach ($scaffoldBuckets as $bucket) {
        ...
        foreach ($incomerSubgroups as $incName) {
            ...
            $incKw = ((float)$inc['active_power_kw'] >= 0.5)
                     ? (float)$inc['active_power_kw'] : 0;
    ...
    // ============================================================
    // Kembalikan daftar device ke Frontend lengkap dengan informasinya (slaveId dan is_incomer)
    $devices = [];
